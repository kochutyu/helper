...
function (_super) {
  ...
  Ukraine.prototype.factoryMethod = function () {
    return new Watch();
  };
...
/** @class */
function (_super) {
  __extends(Chaine, _super);

  function Chaine() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  Chaine.prototype.factoryMethod = function () {
    return new Phone();
  };
...
function () {
  ...
  Product.prototype.setInfo = function (name, version, price) {
    this.name = name;
...
var watch = new Ukraine().factoryMethod();
